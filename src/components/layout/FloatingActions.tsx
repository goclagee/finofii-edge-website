...
/**
 * Fixed floating action buttons in the bottom-right corner.
 *
 * Stacked vertically:
 *  - WhatsApp (top) — opens a chat with the business number.
 *  - Calendly / Book (bottom) — routes to the /book scheduling page.
 *
 * Rendered globally via the root layout so they appear on every page.
 */
